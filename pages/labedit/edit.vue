     ...
     methods: {
       async getData(){
         let { data } = await axios({
           ...
           method: 'post',
           url: `http://localhost:8080/api/laboratory/getLeaderShipById`,
           data:{
             "id": getQueryString("id")
           }
         })
         this.desc = data.extend.results.laborIntroduce;
       ...
       async editResults() {
         ...
         axios({
           ...
           this.$router.push("/laboratory/Introduction?id=" + getQueryString("id"))
         })
       },
       goBack(){
         this.$router.push("/laboratory/Introduction?id=" + getQueryString("id"))
