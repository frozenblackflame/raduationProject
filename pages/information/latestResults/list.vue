<template>
  <center>
    <div style="width: 80%;">
      <el-container>
        <el-header height>
          <el-page-header @back="goBack" content="最新成果"></el-page-header>
        </el-header>
        <el-main>
          <div>
            <el-table :data="listDate" stripe>
  
              <el-table-column prop="title" width="500px" label="标题" show-overflow-tooltip>
              </el-table-column>
...
export default {
  data() {
    return {
      listDate: [{ title: "钢铁行业高炉煤气余能回收透平直驱三机组核心技术研究与应用", time: "2019-5-2" ,url:"./"}]
    };
  },
  methods: {
    goBack() {
