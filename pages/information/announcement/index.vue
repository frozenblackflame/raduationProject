  ...
  export default {
    ...
    methods: {
      async getData() {
        ...
        this.image = data.extend.results[0].annoImg
      ...
      goEdit(){
        this.$router.push('/annoariticle/edit?id='+ getQueryString("id"))
      },
      handleClose () {
      ...
      handleSave(){
        ...
        let {data} = axios({
          withCredentials: false,
          method: 'post',
          url: `http://localhost:8080/api/announcement/deleteAnnouncements`,
          data: {
            "id": id
          }
        })
