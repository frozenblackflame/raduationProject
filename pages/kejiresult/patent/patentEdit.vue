  ...
  export default {
    ...
    methods: {
      async getData(){
        ...
        this.name = data.extend.results.patentName
        this.desc = data.extend.results.patentDetails;
        this.imgUrl = data.extend.results.patentImg;
