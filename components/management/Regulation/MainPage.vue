    ...
    methods: {
      async getData() {
        ...
        let {data} = await axios({
          ...
          method: 'post',
          url: `http://localhost:8080/api/providedesc/getAllProvide`,
          // data: {
          //   "id": id
          // }
        })
        this.content = data.extend.results[0].provide
      ...
      goEdit() {
        this.$router.push('/manaedit/provideedit?id=' + this.id)
      }
    },
    created() {
      this.getData()
